...
export function AudioAdvancedSettings() {
  ...
  const patchAudio = useSettingsStore((s) => s.patchAudioAdvanced);
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) => patchAudio({ codec: e.target.value as "mp3" | "aac" | "opus" | "flac" | "wav" })}
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => patchAudio({ kbps: parseInt(e.target.value) })}
          className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-zinc-200 focus:outline-none focus:border-indigo-500"
        />
      </div>
      ...
      <div>
        ...
        <select
          ...
          onChange={(e) => patchAudio({ sampleRate: e.target.value ? parseInt(e.target.value) : undefined })}
          className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-zinc-200 focus:outline-none focus:border-indigo-500"
        >
